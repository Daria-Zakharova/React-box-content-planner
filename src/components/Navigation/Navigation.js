...
export const Navigation = ({onClickMenu}) => {
    return(
        <Stack direction="row" alignItems="baseline" component={Nav}>
            ...
            <NavItem to="/react-box-content-planner/" style={{margin: "0 32px"}}><HomeRounded style={{marginBottom: "-4px"}}/> Home</NavItem>
            <NavItem to="/react-box-content-planner/boxes"><WidgetsRounded style={{marginBottom: "-4px"}}/> Boxes</NavItem> 
        </Stack>
    );
}
